...
CREATE TABLE instructor (
 ...
 sound_good_school_id VARCHAR(100),
 contact_details_id INT NOT NULL
);
...
ALTER TABLE sibling_discount ADD CONSTRAINT FK_sibling_discount_0 FOREIGN KEY (student_payment_id) REFERENCES student_payment (id);
...
ALTER TABLE student ADD CONSTRAINT FK_student_2 FOREIGN KEY (sibling_discount_id) REFERENCES sibling_discount (id);
